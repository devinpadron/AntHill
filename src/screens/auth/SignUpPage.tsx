	...
	return (
		<View style={{ flex: 1, backgroundColor: Cream[100] }}>
			...
			>
				...
				>
					<AntGlyph size={240} color={Ink[900]} />
				</View>
				<View
					style={{
						position: "absolute",
				...
				>
					<AntGlyph size={170} color={Ink[900]} />
				</View>
			</View>
				...
				>
					...
					>
						...
						<View style={{ paddingHorizontal: 32, paddingTop: 32 }}>
							...
							>
								Create your account with the access code your
								manager gave you.
							</Text>
						</View>
						...
						<View style={{ paddingHorizontal: 24, paddingTop: 28 }}>
							...
							<Field
								...
								password={!showConfPassword}
								trailing={showConfPassword ? "Hide" : "Show"}
								onPressTrailing={() =>
									setShowConfPassword((v) => !v)
								}
								placeholder="••••••••"
							/>
							<View style={{ height: 12 }} />
